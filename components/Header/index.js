      ...
      {isMenuOpen && (
        <div className={styles.overlay}>
          <div className={styles.menu}>
            ...
            <Link href="/menu-item-3" className={styles.menuItem}><Image className={styles.hamIcon} src="/images/trophey.svg" width={30} height={30} alt="acheivments icon"/>Achievements</Link>
